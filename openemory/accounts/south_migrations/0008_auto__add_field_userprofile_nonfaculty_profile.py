# file openemory/accounts/migrations/0008_auto__add_field_userprofile_nonfaculty_profile.py
# 
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.nonfaculty_profile'
        db.add_column('accounts_userprofile', 'nonfaculty_profile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.nonfaculty_profile'
        db.delete_column('accounts_userprofile', 'nonfaculty_profile')
