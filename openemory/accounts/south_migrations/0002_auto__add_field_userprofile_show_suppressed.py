# file openemory/accounts/migrations/0002_auto__add_field_userprofile_show_suppressed.py
# 
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.show_suppressed'
        db.add_column('accounts_userprofile', 'show_suppressed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.show_suppressed'
        db.delete_column('accounts_userprofile', 'show_suppressed')
