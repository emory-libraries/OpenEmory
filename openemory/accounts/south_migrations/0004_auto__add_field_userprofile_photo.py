# file openemory/accounts/migrations/0004_auto__add_field_userprofile_photo.py
# 
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'photo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.photo'
        db.delete_column('accounts_userprofile', 'photo')
