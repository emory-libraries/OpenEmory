# file openemory/accounts/migrations/0009_load_site_admin_group.py
# 
...
class Migration(DataMigration):
    '''This migration loads a fixture to define a Site Admin group
    with all the permissions Site Admins should have.  As such, it
    depends on at least the initial migrations from other parts of
    :mod:`openemory`, since models must be defined before the related
    permissions an be referenced.
    '''
    depends_on = (
    ...
    def backwards(self, orm):
        ...
        try:
            ...
            logger.warn('Could not find Site Admin group for removal')
            pass
