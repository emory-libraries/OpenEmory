# file openemory/accounts/migrations/0007_auto__add_grant.py
# 
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Grant'
        db.create_table('accounts_grant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('grantee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('grantor', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('project_title', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('accounts', ['Grant'])


    def backwards(self, orm):
        
        # Deleting model 'Grant'
        db.delete_table('accounts_grant')
