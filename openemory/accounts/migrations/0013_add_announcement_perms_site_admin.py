# file openemory/accounts/migrations/0013_add_announcement_perms_site_admin.py
# 
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        add_perm= Permission.objects.get(codename='add_announcement')
        change_perm = Permission.objects.get(codename='change_announcement')
        delete_perm = Permission.objects.get(codename='delete_announcement')
